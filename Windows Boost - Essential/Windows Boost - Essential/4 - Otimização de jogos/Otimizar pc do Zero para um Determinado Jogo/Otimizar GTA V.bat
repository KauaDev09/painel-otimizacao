...
set "lines[0]=                        ________ __           ____   ____
set "lines[1]=                       /  _____//  |______    \   \ /   /
set "lines[2]=                      /   \  __\   __\__  \    \   Y   / 
set "lines[3]=                      \    \_\  \  |  / __ \_   \     /  
set "lines[4]=                       \______  /__| (____  /    \___/   
set "lines[5]=                              \/          \/             
...
echo.
echo             %m%[ %m%2 %m%]%w% Aumentar prioridade        %m%[ %m%3 %m%]%w% Otimizar GtaV
echo.
...
:prioridade
echo Aumentando prioridade do GtaV...
...
:gtav
echo Otimizando seu pc para rodar Gta V...
