...
set "lines[0]=              __      __                                          
set "lines[1]=             /  \    /  \_____ ___________________   ____   ____  
set "lines[2]=             \   \/\/   /\__  \\_  __ \___   /  _ \ /    \_/ __ \ 
set "lines[3]=              \        /  / __ \|  | \//    (  <_> )   |  \  ___/ 
set "lines[4]=               \__/\  /  (____  /__|  /_____ \____/|___|  /\___  >
set "lines[5]=                    \/        \/            \/          \/     \/ 
...
echo.
echo             %m%[ %m%2 %m%]%w% Aumentar prioridade        %m%[ %m%3 %m%]%w% Otimizar Warzone
echo.
...
:prioridade
echo Aumentando prioridade do Call of Duty: Warzone...
...
echo Prioridade do COD Warzone ajustada!
pause
cls
goto :menu

:warzone
echo Otimizando Warzone...
