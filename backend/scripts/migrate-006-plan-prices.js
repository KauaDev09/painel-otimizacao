...
const INSTALLER = {
  version: '2.0.6',
  filename: 'SevenOptimizer.OPTIMIZER.Setup-2.0.6.exe',
  url: 'https://github.com/KauaDev09/painel-otimizacao/releases/download/v2.0.6/SevenOptimizer.OPTIMIZER.Setup-2.0.6.exe',
