...
const RELEASE = {
  ...
  changelog: [
    'Suporte oficial no Discord (https://discord.gg/e3jHfF7ANp) no painel, no login e nas Configurações.',
    'Tipografia Inter no aplicativo.',
    'Textos de suporte e licença mais claros.'
  ].join('\n'),
  obrigatoria: false,
