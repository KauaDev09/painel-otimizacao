...
const FAQ: { q: string; a: string }[] = [
  {
    ...
    a: 'Sim. O acesso ao SevenOptimizer exige uma Key válida, adquirida na loja SevenOptimizer e validada com segurança no servidor. Sem Key, o painel não é liberado.',
  },
  {
  ...
  },
  {
    ...
    a: 'A análise é somente leitura. Aplicações automáticas só ocorrem quando existe um método documentado e verificável, sempre com confirmação. Sem suporte seguro, o SevenOptimizer mostra o guia de configuração manual — nunca finge que aplicou algo.',
  },
  {
