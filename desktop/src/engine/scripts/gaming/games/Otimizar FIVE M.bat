...
set "lines[0]=              ___________._______   _______________     _____   
set "lines[1]=              \_   _____/|   \   \ /   /\_   _____/    /     \  
set "lines[2]=               |    __)  |   |\   Y   /  |    __)_    /  \ /  \ 
set "lines[3]=               |     \   |   | \     /   |        \  /    Y    \
set "lines[4]=               \___  /   |___|  \___/   /_______  /  \____|__  /
set "lines[5]=                   \/                           \/           \/ 
...
echo.
echo             %m%[ %m%2 %m%]%w% Aumentar prioridade        %m%[ %m%3 %m%]%w% Otimizar Five M
echo.
