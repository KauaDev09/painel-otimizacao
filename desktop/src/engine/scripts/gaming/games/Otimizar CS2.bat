...
set "lines[0]=                        _________   _________________  
set "lines[1]=                        \_   ___ \ /   _____/\_____  \ 
set "lines[2]=                        /    \  \/ \_____  \  /  ____/ 
set "lines[3]=                        \     \____/        \/       \ 
set "lines[4]=                        \______  /_______  /\_______ \
set "lines[5]=                               \/        \/         \/
...
echo.
echo             %m%[ %m%2 %m%]%w% Aumentar prioridade        %m%[ %m%3 %m%]%w% Otimizar CS2
echo.
...
echo Prioridade do Cs2 ajustada com sucesso!
pause
