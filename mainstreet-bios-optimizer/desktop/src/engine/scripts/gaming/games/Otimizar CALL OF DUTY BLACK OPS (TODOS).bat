...
set "lines[0]=   __________.____       _____  _________  ____  __. ________ __________  _________
set "lines[1]=   \______   \    |     /  _  \ \_   ___ \|    |/ _| \_____  \\______   \/   _____/
set "lines[2]=    |    |  _/    |    /  /_\  \/    \  \/|      <    /   |   \|     ___/\_____  \ 
set "lines[3]=    |    |   \    |___/    |    \     \___|    |  \  /    |    \    |    /        \
set "lines[4]=    |______  /_______ \____|__  /\______  /____|__ \ \_______  /____|   /_______  /
set "lines[5]=           \/        \/       \/        \/        \/         \/                 \/ 
...
echo.
echo             %m%[ %m%2 %m%]%w% Aumentar prioridade        %m%[ %m%3 %m%]%w% Otimizar Call Of duty's
echo.
...
:prioridade
echo Aumentando prioridade do cod...
