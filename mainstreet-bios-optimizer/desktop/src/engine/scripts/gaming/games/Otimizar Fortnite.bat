...
title iGust Fortnite Optimizer
cls
set "ESC="
cls
...
set "lines[0]=              ___________            __         .__  __          
set "lines[1]=              \_   _____/___________/  |_  ____ |__|/  |_  ____   
set "lines[2]=               |    __)/  _ \_  __ \   __\/    \|  \   __\/ __ \ 
set "lines[3]=               |     \(  <_> )  | \/|  | |   |  \  ||  | \  ___/  
set "lines[4]=               \___  / \____/|__|   |__| |___|  /__||__|  \___  >
set "lines[5]=                   \/                         \/              \/ 
...
echo.
echo             %m%[ %m%2 %m%]%w% Aumentar prioridade        %m%[ %m%3 %m%]%w% Otimizar Fortnite
echo.
...
echo Prioridade do Fortnite ajustada com sucesso!
pause
...
:fortnite
echo Otimizando Fortnite...

set CONFIG=%localappdata%\FortniteGame\Saved\Config\WindowsClient
echo [/Script/FortniteGame.FortGameUserSettings] > "%CONFIG%\Engine.ini"
echo bPreferD3D12=False >> "%CONFIG%\Engine.ini"

set CONFIG=%localappdata%\FortniteGame\Saved\Config\WindowsClient\GameUserSettings.ini
