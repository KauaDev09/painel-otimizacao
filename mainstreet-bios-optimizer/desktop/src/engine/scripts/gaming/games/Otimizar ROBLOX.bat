...
set "lines[0]=                 __________      ___.   .__                
set "lines[1]=                 \______   \ ____\_ |__ |  |   _______  ___
set "lines[2]=                  |       _//  _ \| __ \|  |  /  _ \  \/  /
set "lines[3]=                  |    |   (  <_> ) \_\ \  |_(  <_> >    < 
set "lines[4]=                  |____|_  /\____/|___  /____/\____/__/\_ \
set "lines[5]=                         \/           \/                 \/
...
echo.
echo             %m%[ %m%2 %m%]%w% Aumentar prioridade        %m%[ %m%3 %m%]%w% Otimizar Roblox
echo.
...
echo Prioridade do Roblox ajustada!
pause
