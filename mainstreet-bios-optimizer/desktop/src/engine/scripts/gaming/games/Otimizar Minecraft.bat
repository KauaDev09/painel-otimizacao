...
title iGust Minecraft Optimizer
cls
set "ESC="
cls
...
set "lines[0]=                 _____  .__                                   _____  __   
set "lines[1]=                /     \ |__| ____   ____   ________________ _/ ____\/  |_ 
set "lines[2]=               /  \ /  \|  |/    \_/ __ \_/ ___\_  __ \__  \\   __\\   __\
set "lines[3]=              /    Y    \  |   |  \  ___/\  \___|  | \// __ \|  |   |  |  
set "lines[4]=              \____|__  /__|___|  /\___  >\___  >__|  (____  /__|   |__|  
set "lines[5]=                      \/        \/     \/     \/           \/             
...
echo.
echo             %m%[ %m%2 %m%]%w% Aumentar prioridade        %m%[ %m%3 %m%]%w% Otimizar Minecraft
echo.
...
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\java.exe" /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\java.exe\PerfOptions" /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\java.exe\PerfOptions" /v CpuPriorityClass /t REG_DWORD /d 3 /f

reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\Minecraft.Windows.exe" /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\Minecraft.Windows.exe\PerfOptions" /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\Minecraft.Windows.exe\PerfOptions" /v CpuPriorityClass /t REG_DWORD /d 3 /f
echo Prioridade do Minecraft ajustada com sucesso!
pause
...
:minecraft
echo Otimizando seu windows para rodar Minecraft...
