...
const LUCIDE: Record<string, string> = {
  ...
  'line-chart':
    '<path d="M3 3v16a2 2 0 0 0 2 2h16"/><path d="M7 15l4-6 4 3 5-8"/>',
  'refresh-cw':
  ...
  loader:
    '<line x1="12" x2="12" y1="2" y2="6"/><line x1="12" x2="12" y1="18" y2="22"/><line x1="4.93" x2="7.76" y1="4.93" y2="7.76"/><line x1="16.24" x2="19.07" y1="16.24" y2="19.07"/><line x1="2" x2="6" y1="12" y2="12"/><line x1="18" x2="22" y1="12" y2="12"/><line x1="4.93" x2="7.76" y1="19.07" y2="19.07"/><line x1="16.24" x2="19.07" y1="7.76" y2="7.76"/>',
  'alert-circle':
...
export function Ico({ name, className = 'ico', ...rest }: IcoProps) {
  const inner = LUCIDE[name];
  if (!inner) return <span className={className} />;
  return (
